      ...
      <div class="nav">
        <div class="au_box">
          <div class="au_nav_a">
            ...
            |
            <router-link to="#">{{ bookInfo.autName }}</router-link>
            |
            ...
            <div class="au_c_form">
              ...
              >
                ...
                <el-upload
                    ...
                    >
                    <img :src="rules.bookPic" style="width: 100%;height: 100%;">
...
import { editBook } from "@/utils/apiBook"
...
export default {
  ...
  methods: {
    ...
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          this.$set(this.ruleForm,"bookId",this.bookInfo.bookId);
          this.$set(this.ruleForm,"autId",this.bookInfo.autId);
          this.$set(this.ruleForm,"autName",this.bookInfo.autName);
          editBook(this.ruleForm);
          this.$router.go(-1);
        } else {
 ...
 async created() {
     ...
     const reqData = {bookId:bookId}
     this.bookInfo = await queryBookInfo(reqData);
     this.ruleForm.bookName = this.bookInfo.bookName;
     this.ruleForm.genre = this.bookInfo.genre;
     this.ruleForm.theme = this.bookInfo.theme;
     this.ruleForm.theme = this.bookInfo.theme;
     this.ruleForm.acronym = this.bookInfo.acronym;
     this.ruleForm.intro = this.bookInfo.intro;
     this.ruleForm.wishes = this.bookInfo.wishes;
     this.ruleForm.collect = this.bookInfo.collect;
     this.rules.bookPic= this.bookInfo.bookPic;
     this.selectWord.value = this.bookInfo.keyWord;
  },
};
</script>
